 ...
 */
@Singleton
public class LogoutCookieFilter implements Filter {

    private final TokenManager                 tokenManager;
    private final TokenExtractor               tokenExtractor;
    private final AuthenticationCookiesBuilder cookiesBuilder;

    private static final Logger LOG = LoggerFactory.getLogger(LogoutCookieFilter.class);

    @Inject
    public LogoutCookieFilter(TokenManager tokenManager, TokenExtractor tokenExtractor,
