...
public class FactoryBuilder extends NonEncodedFactoryBuilder {
    ...
    private static final String INVALID_PARAMETER_MESSAGE                      =
            "Passed in an invalid parameter.  You either provided a non-valid parameter, or that parameter is not accepted for this " +
            "Factory version.  For more information, please visit http://docs.codenvy" +
    ...
    private static final String PARAMETRIZED_INVALID_TRACKED_PARAMETER_MESSAGE =
            "You have provided a Tracked Factory parameter %s, and you do not have a valid orgId %s.  You could have provided the wrong " +
            "code, your subscription has expired, or you do not have a valid subscription account.  Please contact info@codenvy.com with " +
            "any questions.";
    private static final String PARAMETRIZED_INVALID_PARAMETER_MESSAGE         =
            "You have provided an invalid parameter %s for this version of Factory parameters %s.  For more information, " +
            "please visit: http://docs.codenvy.com/user/creating-factories/factory-parameter-reference/.";
    private static final String PARAMETRIZED_ENCODED_ONLY_PARAMETER_MESSAGE    =
            "You submitted a parameter that can only be submitted through an encoded Factory URL %s.  For more information, " +
            "please visit: http://docs.codenvy.com/user/creating-factories/factory-parameter-reference/.";
