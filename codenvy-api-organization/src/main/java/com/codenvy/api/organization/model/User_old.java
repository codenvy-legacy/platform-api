...
/**
 * POJO representation of user entity used in organization service.  User_old is the main unit of {@link }UserDBService).
 * This is how a user interacts with the other entities: <ul> <li>User_old can be a member of zero or more {@link
 * Workspace}.</li> <li>User_old can own zero or more {@link Account}.</li> <li>User_old can have zero or more {@link
 * Role}.</li> <li>User_old always has a {@link Profile}.</li> <li>User_old always has at least one alias (which equals to its
 * identifier), but can have more.</li> </ul>
 */
public class User_old extends AbstractOrganizationUnit {
    /**
     ...
     * be used for User_old-Workspace and User_old-Account relations.
     */
    ...
    public User_old(String alias) {
        addAlias(alias);
    }

    public User_old(String alias, String password) {
        addAlias(alias);
        this.password = password;
    }

    public User_old(User_old source) {
