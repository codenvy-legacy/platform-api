...
public class AccountServiceTest {
    ...
    public void shouldThrowConflictExceptionIfUserHasMore1SaasSubscription() throws Exception {
        ...
        accountSubscription.put("RAM", "256MB");
        accountSubscription.put("Package", "Enterprise");
        Subscription subscription = createSubscription().withServiceId("Saas").withProperties(
                accountSubscription);

        when(accountDao.getActiveSubscriptions(ACCOUNT_ID, "Saas")).thenReturn(Arrays.asList(subscription, subscription));
    ...
    @Test
    public void shouldThrowConflictExceptionIfUserHasNoSaasSubscription() throws Exception {
        when(accountDao.getActiveSubscriptions(ACCOUNT_ID, "Saas")).thenReturn(Collections.<Subscription>emptyList());
